...
from TestDialogs.BoatsAddDialog import BoatsAddDialog
from TestDialogs.BoatsEditDialog import BoatsEditDialog
...
from PageEnums import HeadersBoats
from TestPageObjects.Table.BaseTable import BaseTable
from TestPages.TestPageObjects.Table.TableRow import TableType


class BoatsPage(BaseDashboardPage):
    def navigate(self):
        self.wait()
        self.dashboard_object.main_menu_boats_button.click()
        self.wait_for_page()
