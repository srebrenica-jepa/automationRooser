...
class CustomersAddDialog(NotificationVerifier):
    def __init__(self, webdriver):
        super(CustomersAddDialog, self).__init__(webdriver)
    ...
    def add_entry_and_save(self, name, sage_code, display=None, transport=None,
