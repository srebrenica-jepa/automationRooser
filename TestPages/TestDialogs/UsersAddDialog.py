...
class UsersAddDialog(NotificationVerifier):
    def __init__(self, webdriver):
        super(UsersAddDialog, self).__init__(webdriver)
    ...
    def add_entry_and_save(self, first_name, last_name, email, password, role=None, market=None):
        self.wait()
