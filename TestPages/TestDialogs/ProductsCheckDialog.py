...
from TestPages.TestDialogs.ProductsEditDialog import ProductsEditDialog
...
class ProductsCheckDialog(object):
    ...
    def edit_entry(self, name, display, sage, default_cut):
        self.wait()
