...
class MarketsAddDialog(NotificationVerifier):
    def __init__(self, webdriver):
        super(MarketsAddDialog, self).__init__(webdriver)
    ...
    def add_entry_and_save(self, name, number_of_doors, delivery_time=None, market_cost=None):
        self.wait()
